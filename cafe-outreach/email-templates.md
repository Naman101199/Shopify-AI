...
## Template 2: Follow-Up #1 (5–7 days after initial email)

**Subject:** Re: Granola toppings your bowls will thank you for
...
If this sounds interesting, just reply here and I'll get a sample out to you.
...
It was great meeting you at [Cafe Name]! Really enjoyed seeing the space and talking about the menu.
...
Let me know if you'd like to start with a trial order, or if you have any questions about specific flavours.
...
## Gmail Label Pipeline

Apply these labels to track each cafe thread:

| Label | Meaning |
|-------|---------|
| `TRT Cafe Outreach/1 - Identified` | Cafe added to list, not yet contacted |
| `TRT Cafe Outreach/2 - Contacted` | Initial email sent |
| `TRT Cafe Outreach/3 - Replied` | Cafe responded (positive or neutral) |
| `TRT Cafe Outreach/4 - Meeting` | Call or in-person meeting scheduled |
| `TRT Cafe Outreach/5 - Partner` | Active B2B partner |
...
- [ ] Set calendar reminder: follow up in 6 days
- [ ] If no reply → send Template 2, update reminder to +7 days
- [ ] If no reply → send Template 3 (final)
- [ ] If reply → move to `3 - Replied`, schedule meeting
- [ ] Post-meeting → send Template 4 with catalog attached
